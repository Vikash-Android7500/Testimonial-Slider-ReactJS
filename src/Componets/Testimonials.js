...
const Testimonials = (props) => {
  ...
  return (
    <section className="w-[85vw] md:w-[768px] bg-violet-100 flex flex-col justify-center items-center mt-10 p-10 transition-all duration-300 hover:shadow-xl shadow-violet-300 rounded-md">
      <Card review={reviews[index]} />

      <section className="mx-auto flex gap-5 mt-5 items-center text-violet-400 font-bold text-2xl">
        <button
